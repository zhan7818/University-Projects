...
IcyGenerator.prototype = {
    ...
    makeIcy: function(shape) {
        ...
        icy.style = 'width: 60px; height: 60px; margin: 10px; background-color: Aqua; cursor: move; position: absolute;' 
        if (shape == "circle") {
